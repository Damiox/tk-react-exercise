...
describe('<RecipeForm>', () => {
  it('renders the form with initial values', () => {
    ...
    if (app) {
      const textInputHtml = app.querySelector('.recipe-name') as HTMLInputElement
      expect(textInputHtml).toBeInTheDocument()
      expect(textInputHtml.value).toEqual(recipeData.name)
      const textInputAreaHtml = app.querySelector('.recipe-desc') as HTMLTextAreaElement
  ...
  it('submits the form', () => {
    ...
    if (app) {
      ...
      const buttonSaveHtml = app.querySelector('.recipe-save') as HTMLButtonElement
